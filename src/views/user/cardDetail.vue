        ...
        <el-col :span="50">
          <div class="info" style="width: 500px; margin-top: 10px">
            ...
            <el-row style="align-items: center; width: 500px">
              ...
              <button
                @click="cancelFocusOn(detail.user.id)"
                class="focusOn"
                v-if="checkFollow(detail.user.id)"
              >
                已关注
              </button>
              <button class="focusOn" v-else @click="doFocusOn(detail.user.id)">
                关注
              </button>
            </el-row>
            <!-- 卡片头部结束 -->
            <div class="main-content">
              ...
              >
                ...
                <div v-else class="commentBox">
                  <div class="commentTitle" style="margin-bottom: 5px">
            ...
            <div class="buttonArea">
              <el-row>
                ...
                >
                  ...
                  <el-text size="large" tag="b" type="info">{{
                    detail.likeCount
                  }}</el-text>
                </el-button>
                <el-button
                  link
                  class="warp"
                  @click="doSomething('collect', detail)"
                  :disabled="review"
                >
                  <svg
                    x="1689148085763"
